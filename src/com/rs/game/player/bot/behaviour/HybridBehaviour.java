...
public class HybridBehaviour extends Behaviour {
    ...
    public HybridBehaviour() {
        super(new RandomWalkAction(), new OutOfFoodTeleportAction(), new EatFoodAction(), new CastSpellAction(), new PerformSpecialAttackAction(), new EnablePrayerAction(),  new DrinkRestoreAction(), new AttackPlayerAction(), new HybridSwitchEquipmentAction());
    }
