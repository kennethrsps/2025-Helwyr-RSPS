...
public class RepairItems {
	...
	public enum BrokenItems {
		...
		aASCENSION_CROSSBOW(28437, 28437, 4500000),

		aASCENSION_CROSSBOW_BARROWS(33318, 33318, 4500000),

		aASCENSION_CROSSBOW_SHADOW(33384, 33384, 4500000),

		aASCENSION_CROSSBOW_THIRD_AGE(33450, 33450, 4500000),

		aASCENSION_CROSSBOW_BLOOD(36321, 36321, 4500000),

		aASCENSION_CROSSBOW_HALF(28439, 28437, 2750000),

		aASCENSION_CROSSBOW_BARROWS_HALF(33319, 33318, 2750000),

		aASCENSION_CROSSBOW_SHADOW_HALF(33385, 33384, 2750000),

		aASCENSION_CROSSBOW_THIRD_AGE_HALF(33451, 33450, 2750000),

		aASCENSION_CROSSBOW_BLOOD_HALF(36322, 36321, 2750000),

		aNOXIOUS_SCYTHE(31725, 31725, 4500000),

		aNOXIOUS_SCYTHE_HALF(31727, 31725, 2750000),

		aNOXIOUS_SCYTHE_BARROWS(33330, 33330, 4500000),

		aNOXIOUS_SCYTHE_BARROWS_HALF(33331, 33330, 2750000),

		aNOXIOUS_SCYTHE_SHADOW(33396, 33396, 4500000),

		aNOXIOUS_SCYTHE_SHADOW_HALF(33397, 33396, 2750000),

		aNOXIOUS_SCYTHE_THIRD_AGE(33462, 33462, 4500000),

		aNOXIOUS_SCYTHE_THIRD_AGE_HALF(33463, 33462, 2750000),

		aNOXIOUS_SCYTHE_BLOOD(36333, 36333, 4500000),

		aNOXIOUS_SCYTHE_BLOOD_HALF(36334, 36333, 2750000),

		aNOXIOUS_STAFF(31729, 31729, 4500000),

		aNOXIOUS_STAFF_HALF(31731, 31729, 2750000),

		aNOXIOUS_STAFF_BARROWS(33333, 33333, 4500000),

		aNOXIOUS_STAFF_BARROWS_HALF(33334, 33333, 2750000),

		aNOXIOUS_STAFF_SHADOW(33399, 33399, 4500000),

		aNOXIOUS_STAFF_SHADOW_HALF(33400, 33399, 2750000),

		aNOXIOUS_STAFF_THIRD_AGE(33465, 33465, 4500000),

		aNOXIOUS_STAFF_THIRD_AGE_HALF(33466, 33465, 2750000),

		aNOXIOUS_STAFF_BLOOD(36336, 36336, 4500000),

		aNOXIOUS_STAFF_BLOOD_HALF(36337, 36336, 2750000),

		aNOXIOUS_LONGBOW(31733, 31733, 4500000),

		aNOXIOUS_LONGBOW_HALF(31735, 31733, 2750000),

		aNOXIOUS_LONGBOW_BARROWS(33336, 33336, 4500000),

		aNOXIOUS_LONGBOW_BARROWS_HALF(33337, 33336, 2750000),

		aNOXIOUS_LONGBOW_SHADOW(33402, 33402, 4500000),

		aNOXIOUS_LONGBOW_SHADOW_HALF(33403, 33402, 2750000),

		aNOXIOUS_LONGBOW_THIRD_AGE(33468, 33468, 4500000),

		aNOXIOUS_LONGBOW_THIRD_AGE_HALF(33469, 33468, 2750000),

		aNOXIOUS_LONGBOW_BLOOD(36339, 36339, 4500000),

		aNOXIOUS_LONGBOW_BLOOD_HALF(36340, 36339, 2750000),

		aDRYGORE_RAPIER(26579, 26579, 3000000),

		aDRYGORE_RAPIER_HALF(26581, 26579, 1500000),

		aDRYGORE_RAPIER_BARROWS(33306, 33306, 3000000),

		aDRYGORE_RAPIER_BARROWS_HALF(33307, 33306, 1500000),

		aDRYGORE_RAPIER_SHADOW(33372, 33372, 1500000),

		aDRYGORE_RAPIER_SHADOW_HALF(33374, 33372, 3000000),

		aDRYGORE_RAPIER_THIRD_AGE(33438, 33438, 1500000),

		aDRYGORE_RAPIER_THIRD_AGE_HALF(33439, 33438, 3000000),

		aDRYGORE_RAPIER_BLOOD(36309, 36309, 1500000),

		aDRYGORE_RAPIER_BLOOD_HALF(36310, 36309, 3000000),

		aDRYGORE_LONGSWORD(26587, 26587, 3000000),

		aDRYGORE_LONGSWORD_HALF(26589, 26587, 1500000),

		aDRYGORE_LONGSWORD_BARROWS(33312, 33312, 3000000),

		aDRYGORE_LONGSWORD_BARROWS_HALF(33314, 33312, 1500000),

		aDRYGORE_LONGSWORD_SHADOW(33378, 33378, 3000000),

		aDRYGORE_LONGSWORD_SHADOW_HALF(33379, 33378, 1500000),

		aDRYGORE_LONGSWORD_THIRD_AGE(33444, 33444, 3000000),

		aDRYGORE_LONGSWORD_THIRD_AGE_HALF(33445, 33444, 1500000),

		aDRYGORE_LONGSWORD_BLOOD(36315, 36315, 3000000),

		aDRYGORE_LONGSWORD_BLOOD_HALF(36316, 36315, 1500000),

		aDRYGORE_MACE(26595, 26595, 3000000),

		aDRYGORE_MACE_HALF(26597, 26595, 1500000),

		aDRYGORE_MACE_BARROWS(33300, 33300, 3000000),

		aDRYGORE_MACE_BARROWS_HALF(33301, 33300, 1500000),

		aDRYGORE_MACE_SHADOW(33366, 33366, 3000000),

		aDRYGORE_MACE_SHADOW_HALF(33366, 33366, 1500000),

		aDRYGORE_MACE_THIRD_AGE(33432, 33432, 3000000),

		aDRYGORE_MACE_THIRD_AGE_HAF(33432, 33432, 1500000),

		aDRYGORE_MACE_BLOOD(36303, 36303, 3000000),

		aDRYGORE_MACE_BLOOD_HALF(36303, 36303, 1500000),

		aSUPERIOR_TETSU_HELM(26322, 26322, 600000),

		aSUPERIOR_TETSU_BODY(26323, 26323, 2400000),

		aSUPERIOR_TETSU_LEGS(26324, 26324, 1200000),

		aSUPERIOR_TETSU_KATANA_HALF(33879, 33879, 1250000),

		aSUPERIOR_TETSU_KATANA(33879, 33879, 2500000),

		aSUPERIOR_DEATH_LOTUS_HELM(26352, 26352, 600000),

		aSUPERIOR_DEATH_LOTUS_CHESTPLATE(26353, 26353, 2400000),

		aSUPERIOR_DEATH_LOTUS_CHAPS(26354, 26354, 1200000),

		aSUPERIOR_SEASINGERS_HOOD(26334, 26334, 600000),

		aSUPERIOR_SEASINGERS_ROBE_TOP(26335, 26335, 2400000),

		aSUPERIOR_SEASINGERS_ROBE_BOTTOM(26336, 26336, 1200000),

		aSUPERIOR_SEASINGER_KIBA_HALF(33886, 33886, 1250000),

		aSUPERIOR_SEASINGER_KIBA(33886, 33886, 2500000),

		aSUPERIOR_SEASINGER_MAKIGAI_HALF(33889, 33889, 1250000),

		aSUPERIOR_SEASINGER_MAKIGAI(33889, 33889, 2500000),

		aASCENSION_GRIPS(31205, 31205, 1000000),

		aCELESTIAL_HANDWRAPS(31191, 31191, 1000000),

		aRAZORBACK_GAUNTLETS(30215, 30215, 1000000),
		////////////////////////////////////////////////////////////////////////
		...
		achto1(35198, 35197, 30_000_000), achto2(35196, 35195, 30_000_000), achto3(35194, 35193, 30_000_000),
		achto4(35192, 35191, 30_000_000), achto5(35190, 35189, 30_000_000), achto6(35188, 35187, 30_000_000),
		achto7(35186, 35185, 30_000_000), achto8(35184, 35183, 30_000_000), achto9(35182, 35181, 30_000_000),
		achto10(35180, 35179, 30_000_000), achto11(35178, 35177, 30_000_000), achto12(35176, 35175, 30_000_000),
		achto13(35174, 35173, 30_000_000), achto14(35172, 35171, 30_000_000), achto15(35170, 35169, 30_000_000),
		achto16(35168, 35167, 30_000_000), achto17(35166, 35165, 30_000_000), achto18(35164, 35163, 30_000_000),
		achto19(35162, 35161, 30_000_000), achto(35160, 35159, 30_000_000),

		aachto1(35197, 35197, 30_000_000), aachto2(35195, 35195, 30_000_000), aachto3(35193, 35193, 30_000_000),
		aachto4(35191, 35191, 30_000_000), aachto5(35189, 35189, 30_000_000), aachto6(35187, 35187, 30_000_000),
		aachto7(35185, 35185, 30_000_000), aachto8(35183, 35183, 30_000_000), aachto9(35181, 35181, 30_000_000),
		aachto10(35179, 35179, 30_000_000), aachto11(35177, 35177, 30_000_000), aachto12(35175, 35175, 30_000_000),
		aachto13(35173, 35173, 30_000_000), aachto14(35171, 35171, 30_000_000), aachto15(35169, 35169, 30_000_000),
		aachto16(35167, 35167, 30_000_000), aachto17(35165, 35165, 30_000_000), aachto18(35163, 35163, 30_000_000),
		aachto19(35161, 35161, 30_000_000), aachto(35159, 35159, 30_000_000)
		...
		private int id; // broken
		private int id2; // fixed
		private int Price;
