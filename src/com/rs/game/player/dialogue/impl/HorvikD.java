...
public class HorvikD extends Dialogue {
    ...
    public void run(int interfaceId, int componentId) {
    	switch (stage) {
    	case -1:
    		sendOptionsDialogue("Select an Option", "No, thanks. I'm just looking around.", "Do you want to trade?", "Tusken Invasion shop");
    		stage = 0;
    		break;
    	case 0:
    		...
    		if (componentId == OPTION_3) {
    			sendPlayerDialogue(NORMAL, "Tusken Invasion shop");
    			stage = 5;
    		}
    		break;
    	case 1:
    	...
    	case 4:
    		...
    		break;
    	case 5:
    		ShopsHandler.openShop(player, 117);//TODO shop ID
    		finish();
    		break;	
    	}
    }
