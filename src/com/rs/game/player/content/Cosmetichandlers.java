...
public class Cosmetichandlers {
	...
	public static void openCosmeticsStore(Player player, int page) {
		Cosmetichandlers.openCosmeticsStore(player, null, page);
	}

	public static void openCosmeticsStore(Player player, String keyWord, int page) {
		player.getDialogueManager().startDialogue("CosmeticShops", page, keyWord);
	}
	...
	public enum Cosmetics {
		...
		COLOSSEUM_OUTFIT(new Cosmetic("Colosseum head", 24595, 0), new Cosmetic("Colosseum shoes", 24601, 10), new Cosmetic("Colosseum jacket", 24597, 4), new Cosmetic("Colosseum legs", 24599, 7)),

		FELINE_OUTFIT(new Cosmetic("Feline ears", 24605, 0), new Cosmetic("Feline tail", 24613, 1), new Cosmetic("Feline jacket", 24607, 4), new Cosmetic("Feline legs", 24609, 7), new Cosmetic("Feline shoes", 24611, 10)),

		GOTHIC_OUTFIT(new Cosmetic("Gothic cape", 24623, 1), new Cosmetic("Gothic shoes", 24621, 10), new Cosmetic("Gothic jacket", 24617, 4), new Cosmetic("Gothic legs", 24619, 7)),

		SWASHBUCKLER_OUTFIT(new Cosmetic("Swashbuckler mask", 24627, 0), new Cosmetic("Swashbuckler cape", 24635, 1), new Cosmetic("Swashbuckler jacket", 24629, 4), new Cosmetic("Swashbuckler legs", 24631, 7), new Cosmetic("Swashbuckler shoes", 24633, 10)),

		ASSASSIN_OUTFIT(new Cosmetic("Assassin hood", 24639, 0), new Cosmetic("Assassin cape", 24649, 1), new Cosmetic("Assassin scimitar", 24651, 3), new Cosmetic("Assassin jacket", 24641, 4), new Cosmetic("Assassin scimitar Off-hand", 26029, 5), new Cosmetic("Assassin legs", 24643, 7), new Cosmetic("Assassin gloves", 24647, 9), new Cosmetic("Assassin shoes", 24645, 10)),

		BEACHWEAR_OUTFIT(new Cosmetic("Beachwear head", 24827, 0), new Cosmetic("Beachwear sandals", 24832, 10), new Cosmetic("Beachwear shirt", 24828, 4), new Cosmetic("Beachwear shorts", 24830, 7)),
		...
		FOX_OUTFIT(new Cosmetic("Fox ears", 25136, 0), new Cosmetic("Fox tail", 25142, 1), new Cosmetic("Fox jacket", 25138, 4), new Cosmetic("Fox legs", 25140, 7), new Cosmetic("Fox shoes", 25144, 10)),

		WOLF_OUTFIT(new Cosmetic("Wolf ears", 25148, 0), new Cosmetic("Wolf tail", 25154, 1), new Cosmetic("Wolf jacket", 25150, 4), new Cosmetic("Wolf legs", 25152, 7), new Cosmetic("Wolf shoes", 25156, 10)),

		PANDA_OUTFIT(new Cosmetic("Panda ears", 25160, 0), new Cosmetic("Panda tail", 25166, 1), new Cosmetic("Panda jacket", 25162, 4), new Cosmetic("Panda legs", 25164, 7), new Cosmetic("Panda shoes", 25168, 10)),

		DWARVEN_WARSUIT_OUTFIT(new Cosmetic("Dwarven Warsuit helm", 25273, 0), new Cosmetic("Dwarven Warsuit chest", 25275, 4), new Cosmetic("Dwarven Warsuit legwear", 25277, 7), new Cosmetic("Dwarven Warsuit gauntlets", 25279, 9), new Cosmetic("Dwarven Warsuit boots", 25281, 10)),
		...
		KRILS_GODCRUSHER_ARMOUR(new Cosmetic("K'ril's Godcrusher helm", 25386, 0), new Cosmetic("K'ril's Godcrusher winged cape", 25396, 1), new Cosmetic("K'ril's Godcrusher chest armour", 25388, 4), new Cosmetic("K'ril's Godcrusher leg armour", 25390, 7), new Cosmetic("K'ril's Godcrusher gauntlets", 25392, 9), new Cosmetic("K'ril's Godcrusher boots", 25394, 10)),

		ARIANES_OUTFIT(new Cosmetic("Ariane's tiara", 26043, 0), new Cosmetic("Ariane's robe", 26045, 4), new Cosmetic("Ariane's robe", 26047, 7), new Cosmetic("Ariane's bracers", 26049, 9), new Cosmetic("Ariane's boots", 26051, 10)),

		OZANS_OUTFIT(new Cosmetic("Ozan's cape", 26071, 1), new Cosmetic("Ozan's tunic", 26063, 4), new Cosmetic("Ozan's breeches", 26065, 7), new Cosmetic("Ozan's gloves", 26067, 9), new Cosmetic("Ozan's boots", 26069, 10)),
		...
		EASTERN_CAPTAINS_OUTFIT(new Cosmetic("Eastern Captain's tricorne", 26402, 0), new Cosmetic("Eastern Captain's coat", 26404, 4), new Cosmetic("Eastern Captain's trousers", 26406, 7), new Cosmetic("Eastern Captain's gloves", 26408, 9), new Cosmetic("Eastern Captain's boots", 26410, 10)),

		EASTERN_CREWS_OUTFIT(new Cosmetic("Eastern Crew's hat", 26414, 0), new Cosmetic("Eastern Crew's shirt", 26416, 4), new Cosmetic("Eastern Crew's trousers", 26418, 7), new Cosmetic("Eastern Crew's gloves", 26420, 9), new Cosmetic("Eastern Crew's boots", 26422, 10)),

		WESTERN_CAPTAINS_OUTFIT(new Cosmetic("Western Captain's hat", 26390, 0), new Cosmetic("Western Captain's coat", 26392, 4), new Cosmetic("Western Captain's trousers", 26394, 7), new Cosmetic("Western Captain's gloves", 26396, 9), new Cosmetic("Western Captain's boots", 26398, 10)),

		WESTERN_CREWS_OUTFIT(new Cosmetic("Western Crew's hat", 26426, 0), new Cosmetic("Western Crew's shirt", 26428, 4), new Cosmetic("Western Crew's trousers", 26430, 7), new Cosmetic("Western Crew's gloves", 26432, 9), new Cosmetic("Western Crew's boots", 26434, 10)),
		...
		KALPHITE_SENTINEL_OUTFIT(new Cosmetic("Kalphite helm", 27075, 0), new Cosmetic("Kalphite cape", 27076, 1), new Cosmetic("Kalphite chestplate", 27077, 4), new Cosmetic("Kalphite platelegs", 27079, 7), new Cosmetic("Kalphite gauntlets", 27078, 9), new Cosmetic("Kalphite armoured boots", 27080, 10)),

		KALPHITE_EMISSARY_OUTFIT(new Cosmetic("Kalphite antennae", 27083, 0), new Cosmetic("Kalphite wing cape", 27084, 1), new Cosmetic("Kalphite robe top", 27085, 4), new Cosmetic("Kalphite lower robes", 27087, 7), new Cosmetic("Kalphite gloves", 27086, 9), new Cosmetic("Kalphite boots", 27088, 10)),

		SHADOW_CAT_OUTFIT(new Cosmetic("Shadow Cat ears", 27174, 0), new Cosmetic("Shadow Cat tail", 27178, 1), new Cosmetic("Shadow Cat jacket", 27175, 4), new Cosmetic("Shadow Cat legs", 27176, 7), new Cosmetic("Shadow Cat shoes", 27177, 10)),
		...
		GREATER_DEMONFLESH_ARMOUR(new Cosmetic("Greater demonflesh mask", 27120, 0), new Cosmetic("Greater demonflesh cape", 27130, 1), new Cosmetic("Greater demonflesh torso", 27122, 4), new Cosmetic("Greater demonflesh legs", 27124, 7), new Cosmetic("Greater demonflesh gloves", 27126, 9), new Cosmetic("Greater demonflesh boots", 27128, 10)),

		LESSER_DEMONFLESH_ARMOUR(new Cosmetic("Lesser demonflesh mask", 27134, 0), new Cosmetic("Lesser demonflesh torso", 27136, 4), new Cosmetic("Lesser demonflesh legs", 27138, 7), new Cosmetic("Lesser demonflesh gloves", 27140, 9), new Cosmetic("Lesser demonflesh boots", 27142, 10)),
		...
		GUTHIXIAN_WAR_ROBES(new Cosmetic("Guthixian war hood", 27419, 0), new Cosmetic("Guthixian war robe", 27421, 4), new Cosmetic("Guthixian war robe", 27423, 7), new Cosmetic("Guthixian war gloves", 27425, 9), new Cosmetic("Guthixian war boots", 27427, 10)),

		SARADOMINIST_WAR_ROBES(new Cosmetic("Saradominist war hood", 27431, 0), new Cosmetic("Saradominist war robe", 27433, 4), new Cosmetic("Saradominist war robe", 27435, 7), new Cosmetic("Saradominist war gloves", 27437, 9), new Cosmetic("Saradominist war boots", 27439, 10)),

		ZAMORAKIAN_WAR_ROBES(new Cosmetic("Zamorakian war hood", 27443, 0), new Cosmetic("Zamorakian war robe", 27445, 4), new Cosmetic("Zamorakian war robe", 27447, 7), new Cosmetic("Zamorakian war gloves", 27449, 9), new Cosmetic("Zamorakian war boots", 27451, 10)),

		ZAROSIAN_WAR_ROBES(new Cosmetic("Zarosian war hood", 27455, 0), new Cosmetic("Zarosian war robe", 27457, 4), new Cosmetic("Zarosian war robe", 27459, 7), new Cosmetic("Zarosian war gloves", 27461, 9), new Cosmetic("Zarosian war boots", 27463, 10)),

		ROBES_OF_SORROW_OUTFIT(new Cosmetic("Cowl of Sorrow", 27557, 0), new Cosmetic("Robes of Sorrow", 27558, 4), new Cosmetic("Robes of Sorrow", 27560, 7), new Cosmetic("Gauntlets of Sorrow", 27559, 9), new Cosmetic("Boots of Sorrow", 27561, 10)),

		VESTMENTS_OF_SORROW_OUTFIT(new Cosmetic("Hood of Sorrow", 27565, 0), new Cosmetic("Vestments of Sorrow", 27566, 4), new Cosmetic("Vestments of Sorrow", 27568, 7), new Cosmetic("Gloves of Sorrow", 27567, 9), new Cosmetic("Footwear of Sorrow", 27569, 10)),

		ROBES_OF_REMEMBRANCE_OUTFIT(new Cosmetic("Garland of Remembrance", 27572, 0), new Cosmetic("Robes of Remembrance", 27573, 4), new Cosmetic("Robes of Remembrance", 27575, 7), new Cosmetic("Bracers of Remembrance", 27574, 9), new Cosmetic("Sandals of Remembrance", 27576, 10)),

		VESTMENTS_OF_REMEMBRANCE_OUTFIT(new Cosmetic("Wreath of Remembrance", 27580, 0), new Cosmetic("Vestments of Remembrance", 27581, 4), new Cosmetic("Vestments of Remembrance", 27583, 7), new Cosmetic("Handwraps of Remembrance", 27582, 9), new Cosmetic("Footwraps of Remembrance", 27584, 10)),
		...
		EXECUTIONER_OUTFIT(new Cosmetic("Executioner cowl", 28001, 0), new Cosmetic("Executioner robe", 28003, 4), new Cosmetic("Executioner robe", 28007, 7), new Cosmetic("Executioner gloves", 28005, 9), new Cosmetic("Executioner boots", 28009, 10)),

		FLAMEHEART_ARMOUR(new Cosmetic("Flameheart headgear", 28049, 0), new Cosmetic("Flameheart chest", 28050, 4), new Cosmetic("Flameheart legs", 28052, 7), new Cosmetic("Flameheart gloves", 28051, 9), new Cosmetic("Flameheart boots", 28053, 10)),

		STONEHEART_ARMOUR(new Cosmetic("Stoneheart helm", 28056, 0), new Cosmetic("Stoneheart chestplate", 28057, 4), new Cosmetic("Stoneheart greaves", 28059, 7), new Cosmetic("Stoneheart gauntlets", 28058, 9), new Cosmetic("Stoneheart boots", 28060, 10)),

		STORMHEART_ARMOUR(new Cosmetic("Stormheart headgear", 28063, 0), new Cosmetic("Stormheart robe", 28064, 4), new Cosmetic("Stormheart robe", 28066, 7), new Cosmetic("Stormheart wraps", 28065, 9), new Cosmetic("Stormheart boots", 28067, 10)),

		ICEHEART_ARMOUR(new Cosmetic("Iceheart headgear", 28070, 0), new Cosmetic("Iceheart robe", 28071, 4), new Cosmetic("Iceheart robe", 28073, 7), new Cosmetic("Iceheart wraps", 28072, 9), new Cosmetic("Iceheart boots", 28074, 10)),

		COLOSSUS_ARMOUR(new Cosmetic("Colossus helm", 28838, 0), new Cosmetic("Colossus cape", 28843, 1), new Cosmetic("Colossus cuirass", 28839, 4), new Cosmetic("Colossus greaves", 28840, 7), new Cosmetic("Colossus gauntlets", 28841, 9), new Cosmetic("Colossus boots", 28842, 10)),

		VETERAN_COLOSSUS_ARMOUR(new Cosmetic("Veteran colossus helm", 28846, 0), new Cosmetic("Veteran colossus cape", 28851, 1), new Cosmetic("Veteran colossus cuirass", 28847, 4), new Cosmetic("Veteran colossus greaves", 28848, 7), new Cosmetic("Veteran colossus gauntlets", 28849, 9), new Cosmetic("Veteran colossus boots", 28850, 10)),

		TITAN_ARMOUR(new Cosmetic("Titan helm", 28854, 0), new Cosmetic("Titan cuirass", 28855, 4), new Cosmetic("Titan greaves", 28856, 7), new Cosmetic("Titan gauntlets", 28857, 9), new Cosmetic("Titan boots", 28858, 10)),

		VETERAN_TITAN_ARMOUR(new Cosmetic("Veteran titan helm", 28861, 0), new Cosmetic("Veteran titan cuirass", 28862, 4), new Cosmetic("Veteran titan greaves", 28863, 7), new Cosmetic("Veteran titan gauntlets", 28864, 9), new Cosmetic("Veteran titan boots", 28865, 10)),

		BEHEMOTH_ARMOUR(new Cosmetic("Behemoth helm", 28868, 0), new Cosmetic("Behemoth cape", 28873, 1), new Cosmetic("Behemoth cuirass", 28869, 4), new Cosmetic("Behemoth greaves", 28870, 7), new Cosmetic("Behemoth gauntlets", 28871, 9), new Cosmetic("Behemoth boots", 28872, 10)),

		VETERAN_BEHEMOTH_ARMOUR(new Cosmetic("Veteran behemoth helm", 28876, 0), new Cosmetic("Veteran behemoth cape", 28881, 1), new Cosmetic("Veteran behemoth cuirass", 28877, 4), new Cosmetic("Veteran behemoth greaves", 28878, 7), new Cosmetic("Veteran behemoth gauntlets", 28879, 9), new Cosmetic("Veteran behemoth boots", 28880, 10)),

		BEAST_ARMOUR(new Cosmetic("Beast helm", 28884, 0), new Cosmetic("Beast cuirass", 28885, 4), new Cosmetic("Beast greaves", 28886, 7), new Cosmetic("Beast gauntlets", 28887, 9), new Cosmetic("Beast boots", 28888, 10)),

		VETERAN_BEAST_ARMOUR(new Cosmetic("Veteran beast helm", 28891, 0), new Cosmetic("Veteran beast cuirass", 28892, 4), new Cosmetic("Veteran beast greaves", 28893, 7), new Cosmetic("Veteran beast gauntlets", 28894, 9), new Cosmetic("Veteran beast boots", 28895, 10)),

		LINZAS_OUTFIT(new Cosmetic("Linza's gloves", 28954, 9), new Cosmetic("Linza's boots", 28956, 10), new Cosmetic("Linza's leather vest", 28950, 4), new Cosmetic("Linza's apron", 28952, 7)),

		OWENS_ARMAMENTS(new Cosmetic("Owen's gauntlets", 28975, 9), new Cosmetic("Owen's boots", 28977, 10), new Cosmetic("Owen's cuirass", 28971, 4), new Cosmetic("Owen's cuisses", 28973, 7)),

		DERVISH_OUTFIT(new Cosmetic("Dervish hat", 29009, 0), new Cosmetic("Dervish boots", 29012, 10), new Cosmetic("Dervish robe", 29010, 4), new Cosmetic("Dervish legs", 29011, 7)),

		EASTERN_OUTFIT(new Cosmetic("Eastern hair", 29015, 0), new Cosmetic("Eastern sandals", 29018, 10), new Cosmetic("Eastern robes", 29016, 4), new Cosmetic("Eastern legs", 29017, 7)),

		TRIBAL_OUTFIT(new Cosmetic("Tribal circlet", 29021, 0), new Cosmetic("Tribal shoes", 29024, 10), new Cosmetic("Tribal top", 29022, 4), new Cosmetic("Tribal legs", 29023, 7)),

		SAMBA_OUTFIT(new Cosmetic("Samba headdress", 29027, 0), new Cosmetic("Samba sandals", 29030, 10), new Cosmetic("Samba top", 29028, 4), new Cosmetic("Samba loincloth", 29029, 7)),

		THEATRICAL_OUTFIT(new Cosmetic("Theatrical hat", 29033, 0), new Cosmetic("Theatrical shoes", 29036, 10), new Cosmetic("Theatrical tunic", 29034, 4), new Cosmetic("Theatrical legs", 29035, 7)),

		PHARAOHS_OUTFIT(new Cosmetic("Pharaoh's hat", 29039, 0), new Cosmetic("Pharaoh's sandals", 29042, 10), new Cosmetic("Pharaoh's top", 29040, 4), new Cosmetic("Pharaoh's shendyt", 29041, 7)),

		WUSHANKO_OUTFIT(new Cosmetic("Wushanko hat", 29045, 0), new Cosmetic("Wushanko shoes", 29048, 10), new Cosmetic("Wushanko top", 29046, 4), new Cosmetic("Wushanko legs", 29047, 7)),

		SILKEN_OUTFIT(new Cosmetic("Silken turban", 29051, 0), new Cosmetic("Silken boots", 29054, 10), new Cosmetic("Silken top", 29052, 4), new Cosmetic("Silken legs", 29053, 7)),

		COLONISTS_OUTFIT(new Cosmetic("Colonist's hat", 29057, 0), new Cosmetic("Colonist's boots", 29060, 10), new Cosmetic("Colonist's top", 29058, 4), new Cosmetic("Colonist's legs", 29059, 7)),

		HIGHLAND_OUTFIT(new Cosmetic("Highland war paint", 29063, 0), new Cosmetic("Highland boots", 29066, 10), new Cosmetic("Highland top", 29064, 4), new Cosmetic("Highland kilt", 29065, 7)),

		FEATHERED_SERPENT_OUTFIT(new Cosmetic("Feathered serpent headdress", 29069, 0), new Cosmetic("Feathered serpent boots", 29072, 10), new Cosmetic("Feathered serpent body", 29070, 4), new Cosmetic("Feathered serpent legs", 29071, 7)),

		MUSKETEER_OUTFIT(new Cosmetic("Musketeer hat", 29075, 0), new Cosmetic("Musketeer boots", 29078, 10), new Cosmetic("Musketeer top", 29076, 4), new Cosmetic("Musketeer legs", 29077, 7)),

		ELVEN_OUTFIT(new Cosmetic("Elven wig", 29081, 0), new Cosmetic("Elven shoes", 29084, 10), new Cosmetic("Elven top", 29082, 4), new Cosmetic("Elven legs", 29083, 7)),
		...
		AMBASSADOR_OF_ORDER_OUTFIT(new Cosmetic("Ambassador of Order circlet", 29561, 0), new Cosmetic("Ambassador of Order cloak", 29571, 1), new Cosmetic("Ambassador of Order robe", 29563, 4), new Cosmetic("Ambassador of Order robe", 29565, 7), new Cosmetic("Ambassador of Order gloves", 29567, 9), new Cosmetic("Ambassador of Order shoes", 29569, 10)),

		ENVOY_OF_ORDER_OUTFIT(new Cosmetic("Envoy of Order circlet", 29575, 0), new Cosmetic("Envoy of Order robe", 29577, 4), new Cosmetic("Envoy of Order robe", 29579, 7), new Cosmetic("Envoy of Order gloves", 29581, 9), new Cosmetic("Envoy of Order shoes", 29583, 10)),

		AMBASSADOR_OF_CHAOS(new Cosmetic("Ambassador of Chaos cap", 29587, 0), new Cosmetic("Ambassador of Chaos cloak", 29597, 1), new Cosmetic("Ambassador of Chaos robe", 29589, 4), new Cosmetic("Ambassador of Chaos robe", 29591, 7), new Cosmetic("Ambassador of Chaos gloves", 29593, 9), new Cosmetic("Ambassador of Chaos shoes", 29595, 10)),

		ENVOY_OF_CHAOS_OUTFIT(new Cosmetic("Envoy of Chaos cap", 29601, 0), new Cosmetic("Envoy of Chaos robe", 29603, 4), new Cosmetic("Envoy of Chaos robe", 29605, 7), new Cosmetic("Envoy of Chaos gloves", 29607, 9), new Cosmetic("Envoy of Chaos shoes", 29609, 10)),

		AURORA_ARMOUR(new Cosmetic("Aurora helm", 28428, 0), new Cosmetic("Aurora longsword", 28429, 3), new Cosmetic("Aurora cuirass", 28431, 4), new Cosmetic("Off-hand Aurora longsword", 28430, 5), new Cosmetic("Aurora greaves", 28432, 7), new Cosmetic("Aurora gauntlets", 28433, 9), new Cosmetic("Aurora boots", 28434, 10)),

		TEMPLAR_ARMOUR(new Cosmetic("Templar helm", 28941, 0), new Cosmetic("Templar cuirass", 28942, 4), new Cosmetic("Templar greaves", 28943, 7), new Cosmetic("Templar gauntlets", 28944, 9), new Cosmetic("Templar boots", 28945, 10)),

		SUPERHERO_OUTFIT(new Cosmetic("Superhero mask", 29421, 0), new Cosmetic("Superhero cape", 29424, 1), new Cosmetic("Superhero top", 29419, 4), new Cosmetic("Superhero legs", 29420, 7)),

		SUPERIOR_HERO_OUTFIT(new Cosmetic("Superior hero mask", 29431, 0), new Cosmetic("Superior hero cape", 29436, 1), new Cosmetic("Superior hero top", 29432, 4), new Cosmetic("Superior hero legs", 29433, 7)),

		DULCIN_ARMOUR(new Cosmetic("Dulcin helm", 29461, 0), new Cosmetic("Dulcin cuirass", 29462, 4), new Cosmetic("Dulcin gown", 29463, 7), new Cosmetic("Dulcin gauntlets", 29464, 9), new Cosmetic("Dulcin boots", 29465, 10)),

		RAVENSKULL_OUTFIT(new Cosmetic("Ravenskull cowl", 29766, 0), new Cosmetic("Ravenskull talon", 29776, 3), new Cosmetic("Ravenskull raiment", 29768, 4), new Cosmetic("Ravenskull talon Off-hand", 29778, 5), new Cosmetic("Ravenskull garb", 29770, 7), new Cosmetic("Ravenskull bracers", 29772, 9), new Cosmetic("Ravenskull treads", 29774, 10)),

		DEATHLESS_REGENT_OUTFIT(new Cosmetic("Deathless Regent headguard", 29782, 0), new Cosmetic("Deathless Regent shroud", 29792, 1), new Cosmetic("Pain", 29794, 3), new Cosmetic("Deathless Regent breastplate", 29784, 4), new Cosmetic("Agony Off-hand", 29796, 5), new Cosmetic("Deathless Regent legplates", 29786, 7), new Cosmetic("Deathless Regent gauntlets", 29788, 9), new Cosmetic("Deathless Regent boots", 29790, 10)),
		...
		DRAKEWING_OUTFIT(new Cosmetic("Drakewing head", 29990, 0), new Cosmetic("Drake wings", 30000, 11), new Cosmetic("Drakewing staff", 30002, 3), new Cosmetic("Drakewing torso", 29992, 4), new Cosmetic("Drakewing legs", 29994, 7), new Cosmetic("Drakewing claws", 29996, 9), new Cosmetic("Drakewing feet", 29998, 10)),

		REPLICA_INFINITY_ROBES(new Cosmetic("Replica infinity hat", 30147, 0), new Cosmetic("Replica infinity top", 30149, 4), new Cosmetic("Replica infinity bottoms", 30151, 7), new Cosmetic("Replica infinity gloves", 30153, 9), new Cosmetic("Replica infinity boots", 30155, 10)),

		REPLICA_INFINITY_ROBES_AIR(new Cosmetic("Replica infinity hat (air)", 30159, 0), new Cosmetic("Replica infinity top (air)", 30161, 4), new Cosmetic("Replica infinity bottoms (air)", 30163, 7), new Cosmetic("Replica infinity gloves", 30153, 9), new Cosmetic("Replica infinity boots", 30155, 10)),

		REPLICA_INFINITY_ROBES_EARTH(new Cosmetic("Replica infinity hat (earth)", 30167, 0), new Cosmetic("Replica infinity top (earth)", 30169, 4), new Cosmetic("Replica infinity bottoms (earth)", 30171, 7), new Cosmetic("Replica infinity gloves", 30153, 9), new Cosmetic("Replica infinity boots", 30155, 10)),

		REPLICA_INFINITY_ROBES_FIRE(new Cosmetic("Replica infinity hat (fire)", 30175, 0), new Cosmetic("Replica infinity top (fire)", 30177, 4), new Cosmetic("Replica infinity bottoms (fire)", 30179, 7), new Cosmetic("Replica infinity gloves", 30153, 9), new Cosmetic("Replica infinity boots", 30155, 10)),

		REPLICA_INFINITY_ROBES_WATER(new Cosmetic("Replica infinity hat (water)", 30183, 0), new Cosmetic("Replica infinity top (water)", 30185, 4), new Cosmetic("Replica infinity bottoms (water)", 30187, 7), new Cosmetic("Replica infinity gloves", 30153, 9), new Cosmetic("Replica infinity boots", 30155, 10)),

		REPLICA_DRAGON_PLATE_ARMOUR(new Cosmetic("Replica dragon full helm", 30191, 0), new Cosmetic("Replica dragon platebody", 30193, 4), new Cosmetic("Replica dragon platelegs", 30194, 7), new Cosmetic("Replica dragon gauntlets", 30195, 9), new Cosmetic("Replica dragon boots", 30196, 10)),

		REPLICA_DRAGON_PLATE_ARMOUR_SP(new Cosmetic("Replica dragon full helm (sp)", 30199, 0), new Cosmetic("Replica dragon platebody (sp)", 30201, 4), new Cosmetic("Replica dragon platelegs (sp)", 30202, 7), new Cosmetic("Replica dragon gauntlets", 30195, 9), new Cosmetic("Replica dragon boots", 30196, 10)),

		REPLICA_DRAGON_PLATE_ARMOUR_OR(new Cosmetic("Replica dragon full helm (or)", 30205, 0), new Cosmetic("Replica dragon platebody (or)", 30207, 4), new Cosmetic("Replica dragon platelegs (or)", 30208, 7), new Cosmetic("Replica dragon gauntlets", 30195, 9), new Cosmetic("Replica dragon boots", 30196, 10)),
		...
		GLAD_TIDINGS_OUTFIT(new Cosmetic("Glad tidings headpiece", 30433, 0), new Cosmetic("Glad tidings cape", 30445, 1), new Cosmetic("Glad tidings shirt", 30437, 4), new Cosmetic("Glad tidings bottoms", 30439, 7), new Cosmetic("Glad tidings handwrap", 30441, 9), new Cosmetic("Glad tidings boots", 30443, 10)),

		GOLEM_OF_STRENGTH_ARMOUR(new Cosmetic("Golem of Strength helm", 30461, 0), new Cosmetic("Golem of Strength cape", 30466, 1), new Cosmetic("Golem of Strength chestplate", 30462, 4), new Cosmetic("Golem of Strength legplates", 30463, 7), new Cosmetic("Golem of Strength gauntlets", 30464, 9), new Cosmetic("Golem of Strength boots", 30465, 10)),

		CONSTRUCT_OF_STRENGTH_ARMOUR(new Cosmetic("Construct of Strength helm", 30469, 0), new Cosmetic("Construct of Strength chestplate", 30470, 4), new Cosmetic("Construct of Strength legplates", 30471, 7), new Cosmetic("Construct of Strength gauntlets", 30472, 9), new Cosmetic("Construct of Strength boots", 30473, 10)),

		GOLEM_OF_JUSTICE_ARMOUR(new Cosmetic("Golem of Justice helm", 30476, 0), new Cosmetic("Golem of Justice cape", 30481, 1), new Cosmetic("Golem of Justice chestplate", 30477, 4), new Cosmetic("Golem of Justice legplates", 30478, 7), new Cosmetic("Golem of Justice gauntlets", 30480, 9), new Cosmetic("Golem of Justice boots", 30479, 10)),

		CONSTRUCT_OF_JUSTICE_ARMOUR(new Cosmetic("Construct of Justice helm", 30484, 0), new Cosmetic("Construct of Justice chestplate", 30485, 4), new Cosmetic("Construct of Justice legplates", 30487, 7), new Cosmetic("Construct of Justice gauntlets", 30486, 9), new Cosmetic("Construct of Justice boots", 30488, 10)),

		BLESSED_SENTINEL_OUTFIT(new Cosmetic("Blessed Sentinel hood", 30597, 0), new Cosmetic("Blessed Sentinel wings", 30602, 11), new Cosmetic("Blessed Sentinel lance", 30603, 3), new Cosmetic("Blessed Sentinel cuirass", 30598, 4), new Cosmetic("Blessed Sentinel robe", 30599, 7), new Cosmetic("Blessed Sentinel gloves", 30601, 9), new Cosmetic("Blessed Sentinel boots", 30600, 10)),

		CURSED_REAVER_OUTFIT(new Cosmetic("Cursed Reaver cowl", 30606, 0), new Cosmetic("Cursed Reaver wings", 30611, 11), new Cosmetic("Cursed Reaver scythe", 30612, 3), new Cosmetic("Cursed Reaver garb", 30607, 4), new Cosmetic("Cursed Reaver garb", 30608, 7), new Cosmetic("Cursed Reaver grasps", 30610, 9), new Cosmetic("Cursed Reaver boots", 30609, 10)),

		REPLICA_VIRTUS_OUTFIT(new Cosmetic("Replica Virtus mask", 30617, 0), new Cosmetic("Replica Virtus robe top", 30618, 4), new Cosmetic("Replica Virtus robe legs", 30619, 7)),

		REPLICA_TORVA_OUTFIT(new Cosmetic("Replica Torva full helm", 30622, 0), new Cosmetic("Replica Torva platebody", 30623, 4), new Cosmetic("Replica Torva platelegs", 30624, 7)),

		REPLICA_PERNIX_OUTFIT(new Cosmetic("Replica Pernix cowl", 30627, 0), new Cosmetic("Replica Pernix body", 30628, 4), new Cosmetic("Replica Pernix chaps", 30629, 7)),

		CLOWN_COSTUME(new Cosmetic("Clown hat", 30952, 0), new Cosmetic("Tambourine", 30956, 3), new Cosmetic("Clown shirt", 30953, 4), new Cosmetic("Clown leggings", 30954, 7), new Cosmetic("Clown shoes", 30955, 10)),

		RINGMASTER_COSTUME(new Cosmetic("Ringmaster hat", 30959, 0), new Cosmetic("Mega-phonus", 30963, 3), new Cosmetic("Ringmaster shirt", 30960, 4), new Cosmetic("Ringmaster pants", 30961, 7), new Cosmetic("Ringmaster boots", 30962, 10)),

		ACROBAT_COSTUME(new Cosmetic("Acrobat hat", 30967, 0), new Cosmetic("Acrobat shoes", 30966, 10), new Cosmetic("Acrobat shirt", 30964, 4), new Cosmetic("Acrobat pants", 30965, 7)),

		AUDIENCE_OUTFIT(new Cosmetic("Audience hat", 30974, 0), new Cosmetic("Audience shoes", 30986, 10), new Cosmetic("Audience shirt", 30980, 4), new Cosmetic("Audience pants", 30983, 7)),

		SPECTATORS_OUTFIT(new Cosmetic("Spectator's hat", 30976, 0), new Cosmetic("Spectator's shoes", 30987, 10), new Cosmetic("Spectator's shirt", 30981, 4), new Cosmetic("Spectator's pants", 30984, 7)),

		CIRCUS_GOERS_OUTFIT(new Cosmetic("Circus goer's hat", 30978, 0), new Cosmetic("Circus goer's shirt", 30982, 4), new Cosmetic("Circus goer's pants", 30985, 7)),

		SHADOW_ARIANE_OUTFIT(new Cosmetic("Shadow Ariane's tiara", 31128, 0), new Cosmetic("Shadow Ariane's robe top", 31129, 4), new Cosmetic("Shadow Ariane's robe bottom", 31130, 7), new Cosmetic("Shadow Ariane's bracers", 31131, 9), new Cosmetic("Shadow Ariane's boots", 31132, 10)),

		SHADOW_OZAN_OUTFIT(new Cosmetic("Shadow Ozan's cape", 31139, 1), new Cosmetic("Shadow Ozan's tunic", 31135, 4), new Cosmetic("Shadow Ozan's breeches", 31136, 7), new Cosmetic("Shadow Ozan's gloves", 31137, 9), new Cosmetic("Shadow Ozan's boots", 31138, 10)),

		SHADOW_LINZA_OUTFIT(new Cosmetic("Shadow Linza's gloves", 31113, 9), new Cosmetic("Shadow Linza's boots", 31114, 10), new Cosmetic("Shadow Linza's leather vest", 31111, 4), new Cosmetic("Shadow Linza's apron", 31112, 7)),

		SHADOW_OWEN_OUTFIT(new Cosmetic("Shadow Owen's gauntlets", 31120, 9), new Cosmetic("Shadow Owen's boots", 31121, 10), new Cosmetic("Shadow Owen's cuirass", 31118, 4), new Cosmetic("Shadow Owen's cuisses", 31119, 7)),

		REPLICA_METAL_PLATE_ARMOUR(new Cosmetic("Replica full helm", 31211, 0), new Cosmetic("Replica platebody", 31212, 4), new Cosmetic("Replica platelegs", 31213, 7), new Cosmetic("Replica gloves", 31216, 9), new Cosmetic("Replica boots", 31217, 10)),

		REPLICA_METAL_PLATE_ARMOUR_T(new Cosmetic("Replica full helm (t)", 31219, 0), new Cosmetic("Replica platebody (t)", 31220, 4), new Cosmetic("Replica platelegs (t)", 31221, 7)),

		REPLICA_METAL_PLATE_ARMOUR_G(new Cosmetic("Replica full helm (g)", 31225, 0), new Cosmetic("Replica platebody (g)", 31226, 4), new Cosmetic("Replica platelegs (g)", 31227, 7)),

		REPLICA_ARMADYL_ARMOUR(new Cosmetic("Replica Armadyl helmet", 31232, 0), new Cosmetic("Replica Armadyl chestplate", 31233, 4), new Cosmetic("Replica Armadyl chainskirt", 31234, 7)),

		REPLICA_BANDOS_ARMOUR(new Cosmetic("Replica Bandos chestplate", 31237, 4), new Cosmetic("Replica Bandos boots", 31239, 10), new Cosmetic("Replica Bandos tassets", 31238, 7)),

		HIKER_COSTUME(new Cosmetic("Hiker cap", 31296, 0), new Cosmetic("Hiker backpack", 31300, 1), new Cosmetic("Hiker jacket", 31297, 4), new Cosmetic("Hiker leggings", 31298, 7), new Cosmetic("Hiker gloves", 31301, 9), new Cosmetic("Hiker boots", 31299, 10)),

		AVIANSIE_SKYGUARD_OUTFIT(new Cosmetic("Skyguard head", 31536, 0), new Cosmetic("Skyguard wings", 31543, 11), new Cosmetic("Skyguard longbow", 31541, 3), new Cosmetic("Skyguard mail", 31537, 4), new Cosmetic("Skyguard tassets", 31538, 7), new Cosmetic("Skyguard gauntlets", 31540, 9), new Cosmetic("Skyguard talons", 31539, 10)),

		VYREWATCH_SKYSHADOW_OUTFIT(new Cosmetic("Skyshadow head", 31546, 0), new Cosmetic("Skyshadow wings", 31551, 11), new Cosmetic("Skyshadow staff", 31552, 3), new Cosmetic("Skyshadow vest", 31547, 4), new Cosmetic("Skyshadow bottoms", 31548, 7), new Cosmetic("Skyshadow wristwraps", 31549, 9), new Cosmetic("Skyshadow boots", 31550, 10)),

		REPLICA_VOID_KNIGHT_ARMOUR(new Cosmetic("Replica Void Knight top", 31698, 4), new Cosmetic("Replica Void Knight bottom", 31699, 7)),

		REPLICA_VOID_KNIGHT_EQUIPMENT(new Cosmetic("Replica Void Knight deflector", 31709, 5), new Cosmetic("Replica Void Knight gloves", 31711, 9), new Cosmetic("Replica Void Knight seal", 31710, 2)),

		VANQUISHERS_GEAR(new Cosmetic("Vanquisher's skull", 31833, 0), new Cosmetic("Vanquisher's cuirass", 31834, 4), new Cosmetic("Vanquisher's cuisses", 31835, 7), new Cosmetic("Vanquisher's gauntlets", 31837, 9), new Cosmetic("Vanquisher's greaves", 31836, 10)),

		ZAROSIAN_SHADOW_OUTFIT(new Cosmetic("Zarosian shadow hood", 31975, 0), new Cosmetic("Zarosian shadow robe", 31976, 4), new Cosmetic("Zarosian shadow robe", 31977, 7), new Cosmetic("Zarosian shadow gauntlets", 31978, 9), new Cosmetic("Zarosian shadow boots", 31979, 10)),
		...
		ELVEN_WARRIOR_OUTFIT(new Cosmetic("Elven warrior helmet", 32315, 0), new Cosmetic("Elven warrior armour", 32316, 4), new Cosmetic("Elven warrior tassets", 32317, 7), new Cosmetic("Elven warrior gauntlets", 32319, 9), new Cosmetic("Elven warrior boots", 32318, 10)),
		...
		ELVEN_MAGE_OUTFIT(new Cosmetic("Elven mage helmet", 32329, 0), new Cosmetic("Elven mage robe", 32330, 4), new Cosmetic("Elven mage robe", 32331, 7), new Cosmetic("Elven mage gloves", 32333, 9), new Cosmetic("Elven mage boots", 32332, 10)),

		NEX_OUTFIT(new Cosmetic("Nex helmet", 32543, 0), new Cosmetic("Nex tail", 32549, 1), new Cosmetic("Nex wings", 32548, 11), new Cosmetic("Nex armour", 32544, 4), new Cosmetic("Nex legs", 32545, 7), new Cosmetic("Nex gauntlets", 32547, 9), new Cosmetic("Nex boots", 32546, 10)),

		ATTUNED_NEX_OUTFIT(new Cosmetic("Attuned Nex head", 32551, 0), new Cosmetic("Attuned Nex tail", 32557, 1), new Cosmetic("Attuned Nex wings", 32556, 11), new Cosmetic("Attuned Nex armour", 32552, 4), new Cosmetic("Attuned Nex legs", 32553, 7), new Cosmetic("Attuned Nex gloves", 32555, 9), new Cosmetic("Attuned Nex boots", 32554, 10)),

		KING_BLACK_DRAGON_OUTFIT(new Cosmetic("King Black Dragon head", 32560, 0), new Cosmetic("King Black Dragon tail", 32566, 1), new Cosmetic("King Black Dragon wings", 32565, 11), new Cosmetic("King Black Dragon armour", 32561, 4), new Cosmetic("King Black Dragon legs", 32562, 7), new Cosmetic("King Black Dragon gloves", 32564, 9), new Cosmetic("King Black Dragon boots", 32563, 10)),

		ATTUNED_KING_BLACK_DRAGON_OUTFIT(new Cosmetic("Attuned King Black Dragon head", 32568, 0), new Cosmetic("Attuned King Black Dragon tail", 32574, 1), new Cosmetic("Attuned King Black Dragon wings", 32573, 11), new Cosmetic("Attuned King Black Dragon armour", 32569, 4), new Cosmetic("Attuned King Black Dragon legs", 32570, 7), new Cosmetic("Attuned King Black Dragon gauntlets", 32572, 9), new Cosmetic("Attuned King Black Dragon boots", 32571, 10)),

		SNOWMAN_COSTUME(new Cosmetic("Snowman head", 33593, 0), new Cosmetic("Snowman boots", 33633, 10), new Cosmetic("Ice sickle", 33597, 3), new Cosmetic("Snowman body", 33594, 4), new Cosmetic("Snowstormer", 33596, 14), new Cosmetic("Snowman legs", 33595, 7)),
		...
		OUTFIT_OF_OMENS(-1, new Cosmetic("Helm of Omens", 33711, 0), new Cosmetic("Maul of Omens", 33709, 3), new Cosmetic("Torso of Omens", 33712, 4), new Cosmetic("Legs of Omens", 33713, 7), new Cosmetic("Gloves of Omens", 33715, 9), new Cosmetic("Boots of Omens", 33714, 10)),

		REPLICA_AHRIMS_OUTFIT(new Cosmetic("Replica Ahrim's hood", 33674, 0), new Cosmetic("Replica Ahrim's staff", 33677, 3), new Cosmetic("Replica Ahrim's robe top", 33675, 4), new Cosmetic("Replica Ahrim's robe skirt", 33676, 7)),

		REPLICA_DHAROKS_OUTFIT(new Cosmetic("Replica Dharok's helm", 33680, 0), new Cosmetic("Replica Dharok's greataxe", 33683, 3), new Cosmetic("Replica Dharok's platebody", 33681, 4), new Cosmetic("Replica Dharok's platelegs", 33682, 7)),

		REPLICA_GUTHANS_OUTFIT(new Cosmetic("Replica Guthan's helm", 33686, 0), new Cosmetic("Replica Guthan's warspear", 33689, 3), new Cosmetic("Replica Guthan's platebody", 33687, 4), new Cosmetic("Replica Guthan's chainskirt", 33688, 7)),

		REPLICA_KARILS_OUTFIT(new Cosmetic("Replica Karil's coif", 33692, 0), new Cosmetic("Replica Karil's crossbow", 33695, 3), new Cosmetic("Replica Karil's top", 33693, 4), new Cosmetic("Replica Karil's skirt", 33694, 7)),

		REPLICA_TORAGS_OUTFIT(new Cosmetic("Replica Torag's helm", 33698, 0), new Cosmetic("Replica Torag's hammer", 33701, 3), new Cosmetic("Replica Torag's platebody", 33699, 4), new Cosmetic("Replica Torag's hammer Off-hand", 33702, 5), new Cosmetic("Replica Torag's platelegs", 33700, 7)),

		REPLICA_VERACS_OUTFIT(new Cosmetic("Replica Verac's helm", 33705, 0), new Cosmetic("Replica Verac's flail", 33708, 3), new Cosmetic("Replica Verac's brassard", 33706, 4), new Cosmetic("Replica Verac's plateskirt", 33707, 7)),
		...
		NOMADS_OUTFIT(new Cosmetic("Nomad's gorget", 34099, 0), new Cosmetic("Nomad's cape", 34104, 1), new Cosmetic("Nomad's spear", 34105, 3), new Cosmetic("Nomad's chestplate", 34100, 4), new Cosmetic("Nomad's tassets", 34101, 7), new Cosmetic("Nomad's gloves", 34103, 9), new Cosmetic("Nomad's boots", 34102, 10)),

		GAMEBLAST_OUTFIT(new Cosmetic("GameBlast bandana", 34114, 0), new Cosmetic("GameBlast cape", 34119, 1), new Cosmetic("GameBlast amulet", 34120, 2), new Cosmetic("GameBlast torso", 34115, 4), new Cosmetic("GameBlast legs", 34116, 7), new Cosmetic("GameBlast gloves", 34118, 9), new Cosmetic("GameBlast boots", 34117, 10)),
		...
		NEW_VARROCK_CULTIST_ROBES(new Cosmetic("New Varrock cultist hood", 34319, 0), new Cosmetic("New Varrock cultist top", 34320, 4), new Cosmetic("New Varrock cultist robes", 34321, 7)),
		...
		NEW_VARROCK_ARRAV_OUTFIT(new Cosmetic("New Varrock Arrav's helm", 34329, 0), new Cosmetic("New Varrock Arrav's boots", 34332, 10), new Cosmetic("New Varrock Arrav's heart", 34330, 4), new Cosmetic("New Varrock Arrav's trousers", 34331, 7)),

		ARRAV_OUTFIT(new Cosmetic("Arrav Helm", 34304, 0), new Cosmetic("Arrav Chest", 34305, 4), new Cosmetic("Arrav Legs", 34306, 7), new Cosmetic("Arrav Hands", 34308, 9), new Cosmetic("Arrav Boots", 34307, 10)),

		CURSED_ARRAV_OUTFIT(new Cosmetic("Cursed Arrav Helm", 34310, 0), new Cosmetic("Cursed Arrav Chest", 34311, 4), new Cosmetic("Cursed Arrav Legs", 34312, 7), new Cosmetic("Cursed Arrav Hands", 34314, 9), new Cosmetic("Cursed Arrav Boots", 34313, 10)),

		VITALITY_SUIT(new Cosmetic("Vitality Helmet", 34535, 0), new Cosmetic("Vitality Chest", 34536, 4), new Cosmetic("Vitality Legs", 34537, 7), new Cosmetic("Vitality Gloves", 34539, 9), new Cosmetic("Vitality Feet", 34538, 10)),

		VITALITY_SUIT_INACTIVE(new Cosmetic("Vitality Helmet (inactive)", 34948, 0), new Cosmetic("Vitality Chest (inactive)", 34949, 4), new Cosmetic("Vitality Legs (inactive)", 34950, 7), new Cosmetic("Vitality Gloves (inactive)", 34952, 9), new Cosmetic("Vitality Feet (inactive)", 34951, 10)),

		AQUARIUM_DIVING_SUIT(new Cosmetic("Oyster hunter helmet", 34678, 0), new Cosmetic("Diving suit torso", 34681, 4), new Cosmetic("Diving suit legs", 34682, 7), new Cosmetic("Diving suit gloves", 34684, 9), new Cosmetic("Diving suit boots", 34683, 10)),

		LAVA_OUTFIT(new Cosmetic("Lava Gloves", 34813, 9), new Cosmetic("Lava Boots", 34814, 10), new Cosmetic("Lava Top", 34811, 4), new Cosmetic("Lava Legs", 34812, 7)),

		COGWHEEL(new Cosmetic("Cogwheel Helmet", 34790, 0), new Cosmetic("Cogwheel Chest", 34791, 4), new Cosmetic("Cogwheel Legs", 34792, 7), new Cosmetic("Cogwheel Gloves", 34794, 9), new Cosmetic("Cogwheel Boots", 34793, 10)),
		...
		VS_OUTFIT(new Cosmetic("V's Helmet", 35231, 0), new Cosmetic("V's Cape", 35236, 1), new Cosmetic("V's Broadsword", 35237, 3), new Cosmetic("V's Chestpiece", 35232, 4), new Cosmetic("V's Legguards", 35233, 7), new Cosmetic("V's Gauntlets", 35235, 9), new Cosmetic("V's Sabatons", 35234, 10)),

		BARBARIAN_OUTFIT(new Cosmetic("Barbarian helmet", 35369, 0), new Cosmetic("Barbarian cuirass", 35370, 4), new Cosmetic("Barbarian greaves", 35371, 7), new Cosmetic("Barbarian cuffs", 35373, 9), new Cosmetic("Barbarian boots", 35372, 10)),

		FAREED_OUTFIT(new Cosmetic("Fareed helm", 35673, 0), new Cosmetic("Fareed top", 35674, 4), new Cosmetic("Fareed bottoms", 35675, 7), new Cosmetic("Fareed gauntlets", 35676, 9), new Cosmetic("Fareed boots", 35677, 10)),

		KAMIL_OUTFIT(new Cosmetic("Kamil helm", 35679, 0), new Cosmetic("Kamil top", 35680, 4), new Cosmetic("Kamil bottoms", 35681, 7), new Cosmetic("Kamil gauntlets", 35682, 9), new Cosmetic("Kamil boots", 35683, 10)),

		SPIRIT_HUNTER_OUTFIT(new Cosmetic("Spirit hunter helmet", 35842, 0), new Cosmetic("Spirit hunter flesh jacket", 35843, 4), new Cosmetic("Spirit hunter bottoms", 35844, 7), new Cosmetic("Spirit hunter cuffs", 35846, 9), new Cosmetic("Spirit hunter greaves", 35845, 10)),

		REVENANT_OUTFIT(new Cosmetic("Revenant helmet", 35853, 0), new Cosmetic("Revenant cuirass", 35854, 4), new Cosmetic("Revenant greaves", 35855, 7), new Cosmetic("Revenant cuffs", 35857, 9), new Cosmetic("Revenant boots", 35856, 10)),
		...
		RAPTORS_BASIC_OUTFIT(new Cosmetic("Raptor's Basic Helmet", 36026, 0), new Cosmetic("Raptor's Basic Chestpiece", 36027, 4), new Cosmetic("Raptor's Basic Shield", 36031, 5), new Cosmetic("Raptor's Basic Legguards", 36028, 7), new Cosmetic("Raptor's Basic Gauntlets", 36030, 9), new Cosmetic("Raptor's Basic Sabatons", 36029, 10)),

		RAPTORS_ADVANCED_OUTFIT(new Cosmetic("Raptor's Advanced Helmet", 36035, 0), new Cosmetic("Raptor's Advanced Chestpiece", 36036, 4), new Cosmetic("Raptor's Advanced Shield", 36040, 5), new Cosmetic("Raptor's Advanced Legguards", 36037, 7), new Cosmetic("Raptor's Advanced Gauntlets", 36039, 9), new Cosmetic("Raptor's Advanced Sabatons", 36038, 10)),
		...
		SHADOW_DRAGOON_OUTFIT(new Cosmetic("Shadow Dragoon Helm", 36344, 0), new Cosmetic("Fury's Remorse", 36349, 3), new Cosmetic("Shadow Dragoon Chestplate", 36345, 4), new Cosmetic("Shadow Dragoon Legplates", 36346, 7), new Cosmetic("Shadow Dragoon Gauntlets", 36348, 9), new Cosmetic("Shadow Dragoon Boots", 36347, 10)),

		GROTESQUE_ARMOUR_TIER_1(new Cosmetic("Grotesque Helm (tier 1)", 36739, 0), new Cosmetic("Grotesque Cape (tier 1)", 36744, 1), new Cosmetic("Grotesque Wings (tier 1)", 36745, 11), new Cosmetic("Grotesque Chest (tier 1)", 36740, 4), new Cosmetic("Grotesque Legs (tier 1)", 36741, 7), new Cosmetic("Grotesque Gloves (tier 1)", 36742, 9), new Cosmetic("Grotesque Boots (tier 1)", 36743, 10)),

		GROTESQUE_ARMOUR_TIER_2(new Cosmetic("Grotesque Helm (tier 2)", 36746, 0), new Cosmetic("Grotesque Cape (tier 2)", 36751, 1), new Cosmetic("Grotesque Wings (tier 2)", 36752, 11), new Cosmetic("Grotesque Chest (tier 2)", 36747, 4), new Cosmetic("Grotesque Legs (tier 2)", 36748, 7), new Cosmetic("Grotesque Gloves (tier 2)", 36749, 9), new Cosmetic("Grotesque Boots (tier 2)", 36750, 10)),

		GROTESQUE_ARMOUR_TIER_3(new Cosmetic("Grotesque Helm (tier 3)", 36753, 0), new Cosmetic("Grotesque Cape (tier 3)", 36758, 1), new Cosmetic("Grotesque Wings (tier 3)", 36759, 11), new Cosmetic("Grotesque Chest (tier 3)", 36754, 4), new Cosmetic("Grotesque Legs (tier 3)", 36755, 7), new Cosmetic("Grotesque Gloves (tier 3)", 36756, 9), new Cosmetic("Grotesque Boots (tier 3)", 36757, 10)),
		...
		ELITE_MAMMOTH_ARMOUR(new Cosmetic("Elite Mammoth Helmet", 36883, 0), new Cosmetic("Elite Mammoth Two Hand Tusk Sword", 36888, 3), new Cosmetic("Elite Mammoth Torso", 36884, 4), new Cosmetic("Elite Mammoth Legs", 36885, 7), new Cosmetic("Elite Mammoth Gauntlets", 36887, 9), new Cosmetic("Elite Mammoth Boots", 36886, 10)),

		ANCIENT_OUTFIT(new Cosmetic("Ancient Outfit", 36902, 0), new Cosmetic("Ancient Robe Top", 36905, 4), new Cosmetic("Ancient Robe Bottom", 36906, 7), new Cosmetic("Ancient Cuffs", 36907, 9), new Cosmetic("Ancient Shoes", 36908, 10)),

		ROGUE_OUTFIT(new Cosmetic("Rogue Hood", 36947, 0), new Cosmetic("Rogue Top", 36949, 4), new Cosmetic("Rogue Bottom", 36950, 7), new Cosmetic("Rogue Wristguards", 36951, 9), new Cosmetic("Rogue Sandals", 36952, 10)),
		...
		ROYAL_EASTERN_OUTFIT(new Cosmetic("Royal Eastern Cap", 37215, 0), new Cosmetic("Royal Eastern Wrap Top", 37217, 4), new Cosmetic("Royal Eastern Wrap Bottom", 37218, 7), new Cosmetic("Royal Eastern Gloves", 37219, 9), new Cosmetic("Royal Eastern Geta", 37220, 10)),
		...
		INVESTIGATOR_UNIFORM(new Cosmetic("Investigator's Fedora", 37325, 0), new Cosmetic("Investigator's Coat", 37326, 4), new Cosmetic("Investigator's Trousers", 37327, 7)),
		...
		GRIFFIN_OUTFIT(new Cosmetic("Griffin Crown", 37388, 0), new Cosmetic("Griffin Talons", 37391, 9), new Cosmetic("Griffin Talons", 37392, 10), new Cosmetic("Griffin Wings", 37393, 11), new Cosmetic("Griffin Mantle", 37389, 4), new Cosmetic("Griffin Limbs", 37390, 7)),

		SCORPION_OUTFIT(new Cosmetic("Scorpion Prosoma", 37511, 0), new Cosmetic("Scorpion Tail", 37516, 1), new Cosmetic("Scorpion Carapace", 37512, 4), new Cosmetic("Scorpion Tibia", 37513, 7), new Cosmetic("Scorpion Palps", 37514, 9), new Cosmetic("Scorpion Tarsus", 37515, 10)),
		...
		DEATH_LOTUS_ROGUE_ARMOUR(new Cosmetic("Death Lotus rogue hood", 39005, 0), new Cosmetic("Death Lotus rogue chestplate", 39006, 4), new Cosmetic("Death Lotus rogue chaps", 39007, 7)),

		GU_RONIN_ARMOUR(new Cosmetic("Gu ronin helm", 37859, 0), new Cosmetic("Gu ronin body", 37860, 4), new Cosmetic("Gu ronin platelegs", 37861, 7)),

		SEASINGER_ACOLYTE_ARMOUR(new Cosmetic("Seasinger acolyte hood", 38867, 0), new Cosmetic("Seasinger acolyte robe top", 38868, 4), new Cosmetic("Seasinger acolyte robe bottoms", 38869, 7)),

		FLOURISHING_FAIRY_OUTFIT(new Cosmetic("Petal Coronet", 37853, 0), new Cosmetic("Petal Gloves", 37857, 9), new Cosmetic("Petal Boots", 37856, 10), new Cosmetic("Petal Wings", 37858, 11), new Cosmetic("Petal Top", 37854, 4), new Cosmetic("Petal Bottoms", 37855, 7)),

		SATYR_OUTFIT(new Cosmetic("Satyr Horned Headwear", 38068, 0), new Cosmetic("Satyr Armguards", 38072, 9), new Cosmetic("Satyr Hooves", 38071, 10), new Cosmetic("Satyr Tendril Wings", 38073, 11), new Cosmetic("Satyr Leafy Top", 38069, 4), new Cosmetic("Satyr Hock Legs", 38070, 7)),

		SUMMER_FUN_OUTFIT(new Cosmetic("Summer fun top", 37993, 4), new Cosmetic("Summer fun bottoms", 37994, 7)),

		CRYSTAL_PEACOCK_ARMOUR(new Cosmetic("Crystal Peacock Helmet", 38155, 0), new Cosmetic("Crystal Peacock Body", 38156, 4), new Cosmetic("Crystal Peacock Legs", 38157, 7), new Cosmetic("Crystal Peacock Gloves", 38158, 9), new Cosmetic("Crystal Peacock Boots", 38159, 10)),

		SUNFURY_ARMOUR_TIER_1(new Cosmetic("Sunfury Helm (Tier 1)", 38139, 0), new Cosmetic("Sunfury Cape (Tier 1)", 38149, 1), new Cosmetic("Sunfury Chest (Tier 1)", 38141, 4), new Cosmetic("Sunfury Shield (Tier 1)", 38151, 5), new Cosmetic("Sunfury Legs (Tier 1)", 38143, 7), new Cosmetic("Sunfury Gauntlets (Tier 1)", 38145, 9), new Cosmetic("Sunfury Boots (Tier 1)", 38147, 10)),

		SUNFURY_ARMOUR_TIER_2(new Cosmetic("Sunfury Helm (Tier 2)", 38140, 0), new Cosmetic("Sunfury Cape (Tier 2)", 38150, 1), new Cosmetic("Sunfury Chest (Tier 2)", 38142, 4), new Cosmetic("Sunfury Shield (Tier 2)", 38152, 5), new Cosmetic("Sunfury Legs (Tier 2)", 38144, 7), new Cosmetic("Sunfury Gauntlets (Tier 2)", 38146, 9), new Cosmetic("Sunfury Boots (Tier 2)", 38148, 10)),

		GOSSAMER_OUTFIT(new Cosmetic("Gossamer Feathered Headdress", 38193, 0), new Cosmetic("Gossamer Silk Gloves", 38197, 9), new Cosmetic("Gossamer Pumps", 38196, 10), new Cosmetic("Gossamer Wings", 38198, 11), new Cosmetic("Gossamer Robes Top", 38194, 4), new Cosmetic("Gossamer Robes Bottom", 38195, 7)),

		PRIVATEER_OUTFIT(new Cosmetic("Privateer Tricorn", 38857, 0), new Cosmetic("Privateer Tunic", 38858, 4), new Cosmetic("Privateer Cargo Pants", 38859, 7), new Cosmetic("Privateer Gloves", 38861, 9), new Cosmetic("Privateer Cuffed Boots", 38860, 10)),

		IRONMAN_ARMOUR(new Cosmetic("Ironman helm", 38943, 0), new Cosmetic("Ironman body", 38945, 4), new Cosmetic("Ironman legs", 38947, 7), new Cosmetic("Ironman gauntlets", 38948, 9), new Cosmetic("Ironman boots", 38949, 10)),

		HC_IRONMAN_ARMOUR(new Cosmetic("HC Ironman helm", 38944, 0), new Cosmetic("HC Ironman body", 38946, 4), new Cosmetic("Ironman legs", 38947, 7), new Cosmetic("Ironman gauntlets", 38948, 9), new Cosmetic("Ironman boots", 38949, 10)),

		SPOOKY_SPIDER_OUTFIT(new Cosmetic("Spooky Spider Head", 38893, 0), new Cosmetic("Spooky Spider Gloves", 38896, 9), new Cosmetic("Spooky Spider Boots", 38897, 10), new Cosmetic("Spooky Spider Wings", 38898, 11), new Cosmetic("Spooky Spider Top", 38894, 4), new Cosmetic("Spooky Spider Bottoms", 38895, 7)),

		FALLEN_NIHIL_OUTFIT(new Cosmetic("Fallen Nihil Headpiece", 39041, 0), new Cosmetic("Fallen Nihil Gauntlets", 39045, 9), new Cosmetic("Fallen Nihil Greaves", 39044, 10), new Cosmetic("Fallen Nihil Wings", 39046, 11), new Cosmetic("Fallen Nihil Chestpiece", 39042, 4), new Cosmetic("Fallen Nihil Leg-guards", 39043, 7)),

		NAUTILUS_OUTFIT(new Cosmetic("Nautilus Crown", 39169, 0), new Cosmetic("Nautilus Torso", 39170, 4), new Cosmetic("Nautilus Gown", 39171, 7), new Cosmetic("Nautilus Gloves", 39172, 9), new Cosmetic("Nautilus Boots", 39173, 10)),

		LEGATUS_MAXIMUS_ARMOUR(new Cosmetic("Legatus Maximus Gauntlets", 39257, 9), new Cosmetic("Legatus Maximus Boots", 39258, 10), new Cosmetic("Legatus Maximus Platebody", 39255, 4), new Cosmetic("Legatus Maximus Platelegs", 39256, 7)),
		...
		LOST_SWORD_OF_KING_RADDALLIN_1H_OFFHAND(15, new Cosmetic("Lost sword of King Raddallin (1h) Off-hand", 35940, 5)),
